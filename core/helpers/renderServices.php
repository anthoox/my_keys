 ...
 * renderServices
 * 
 * Función para mostrar los servicios (contraseñas) de un usuario en tarjetas tipo Bootstrap.
 * Cada tarjeta incluye nombre del servicio, usuario, contraseña oculta, botones para mostrar/copiar
 * y opciones de editar o eliminar mediante modales.
 * 
 * @param array $services Array de objetos Service
 */
